...
public class ClientPersonConstants {
    ...
    public static final int VOTER_ID_COL=10; //K
    public static final int RATION_CARD_COL=11; //L
    public static final int DOB_COL=12;//M
    public static final int CLIENT_TYPE_COL=13;//N
    public static final int GENDER_COL=14;//O
    public static final int CLIENT_CLASSIFICATION_COL=15;//P
    public static final int IS_STAFF_COL=16;//Q
    public static final int ADDRESS_ENABLED_COL=17;// R
    ...
    public static final int RESIDENCE_TYPE_COL=26;//AA
    public static final int POSTAL_CODE_COL=27;//AB
    public static final int IS_ACTIVE_ADDRESS_COL=28;//AC
    ...
    public static final int LOOKUP_RESIDENCE_TYPE_COL = 43; //AR
}
